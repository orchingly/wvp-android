package com.ly.wvp.record.play;
...
import com.ly.wvp.widget.progress.SubsectionSeekBar;
...
//    ImageView mCoverImage;
    ...
    private ArrayList<SectionBean> eventSegments = new ArrayList<>();

    private int eventsMax = 0;
...
//        mCoverImage = (ImageView) findViewById(R.id.thumbImage);
        ...
        eventSegmentBar = findViewById(R.id.record_event_action_progress);
    }
    ...
    public void updateProgressBarSeg(List<SectionBean> segList, int max){
        eventsMax = max;
        eventSegments.clear();
        eventSegments.addAll(segList);
        eventSegmentBar.setMax(eventsMax);
        eventSegmentBar.setSectionBeans(eventSegments);
    }

    public void refreshEventProgressBar(){
        eventSegmentBar.setMax(eventsMax);
        eventSegmentBar.setSectionBeans(eventSegments);
    }
...
//        }
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        st.eventsMax = sf.eventsMax;
        st.eventSegments = sf.eventSegments;
    }
